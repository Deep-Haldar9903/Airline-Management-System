...
public class AddPassengerDetail extends JFrame implements ActionListener
{
...
AddPassengerDetail()
{
    super("Add Passenger Detail"); // Set title of the frame
        ...
        l2=new JLabel("Welcome to Air India");
...
String q = "INSERT INTO passenger (username, name, age, dob, address, phone, email, nationality, gender, passport) VALUES ('"+username+"', '"+name+"', '"+age+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+nationality+"', '"+gender+"', '"+passport+"')";
